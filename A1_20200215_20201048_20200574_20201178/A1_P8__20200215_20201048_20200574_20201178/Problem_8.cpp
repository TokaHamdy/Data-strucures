...
int main() {
    ...
    cout << "please enter the size of the array you want to generate to binary insertion sort function" << endl;
    cin >> n;
    ...
    cout << "please enter the size of the array you want to generate to insertion sort function" << endl;
    cin >> n2;
    insertion_sort = new int[n2];
    generate(insertion_sort, insertion_sort + n2, f2);
    auto stt = chrono::high_resolution_clock::now();
    insertionSort(insertion_sort, n2);
